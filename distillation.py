...
class DistillationTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        # If lambda is zero, focus on student CE loss entirely to save teacher calculations and training time.
        # Otherwise, calculate KL loss as well.
        if self.args.lambd <= 0.0:
            ...
            loss = (
                (1.0 - self.args.lambd) * student_outputs.loss
                + self.args.lambd * self.args.temperature**2.0 * kl_loss
            )
